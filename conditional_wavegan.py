...
class ConditionalWaveGANGenerator(nn.Module):
    def __init__(self, model_size=64, ngpus=1, num_channels=1,
                 ...
                 verbose=False, upsample=True, n_classes=10):
        ...
        self.fc1 = nn.Linear(n_classes, 256 * model_size)
...
class ConditionalWaveGANClassifier(nn.Module):
    def __init__(self, model_size=64, ngpus=1, num_channels=1, shift_factor=2,
                 alpha=0.2, n_classes=10, verbose=False):
        ...
        self.fc1 = nn.Linear(256 * model_size, n_classes)
